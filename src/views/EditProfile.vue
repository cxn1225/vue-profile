                ...
                <div class="row">
                    <div class="col-md-8 m-auto">
                        ...
                        <form @submit.prevent="handleSubmit">
                            <TextFieldGroup v-model="msgInfo.handle" placeholder="* Profile handle" name="handle"
                                info="有关于你的个人信息" :error="errors.handle" />
                            ...
                            <TextFieldGroup v-model="msgInfo.githubusername" placeholder="Github 用户名"
                                name="githubusername" info="Github 用户名" :error="errors.githubusername" />

                            <TextAreaGroup placeholder="个人介绍" name="bio" info="自我介绍" :error="errors.bio"
                                v-model="msgInfo.bio" />
                            ...
                            <div v-show="displaySocialInputs">
                                <InputGroup placeholder="QQ" name="QQ" v-model="msgInfo.QQ" :error="errors.QQ"
                                    icon="fa fa-qq" />
                                <InputGroup placeholder="微信公众号" name='wechat' v-model="msgInfo.wechat"
                                    :error='errors.wechat' icon='fa fa-weixin' />

                                <InputGroup placeholder="腾讯课堂网址" name='tengxunkt' v-model="msgInfo.tengxunkt"
                                    :error='errors.tengxunkt' icon='fa fa-wechat' />

                                <InputGroup placeholder="网易课堂网址" name='wangyikt' v-model="msgInfo.wangyikt"
                                    :error='errors.wangyikt' icon='fa fa-wechat' />
